...
public class OracleTableMetaCacheTest {
    ...
    public void getTableMetaTest() throws SQLException {
        ...
        TableMeta tableMeta = tableMetaCache.getTableMeta(proxy.getPlainConnection(), "t.ot1", null);

        Assertions.assertNotNull(tableMeta);

        tableMeta = tableMetaCache.getTableMeta(proxy.getPlainConnection(), "t.\"ot1\"", null);
