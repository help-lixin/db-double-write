...
public class PostgresqlTableMetaCacheTest {
    ...
    public void getTableMetaTest() throws SQLException {
        ...
        TableMeta tableMeta = tableMetaCache.getTableMeta(proxy.getPlainConnection(), "pt1", null);

        Assertions.assertNotNull(tableMeta);

        tableMeta = tableMetaCache.getTableMeta(proxy.getPlainConnection(), "t.pt1", null);
